        ...
        sections: [
          {
            ...
            body: [
              "Professional portraits can be used for corporate websites, team pages, organization charts, presentations, pitches, conferences, articles and interviews. The service can be created for a single professional or for a company team.",
        ...
        sections: [
          {
            ...
            body: [
              "I ritratti professionali possono essere utilizzati per siti aziendali, team page, organigrammi, presentazioni, pitch, conferenze, articoli e interviste. Il servizio può essere realizzato per un singolo professionista o per un team aziendale.",
  ...
  },
  {
    ...
    copy: {
      en: {
        ...
        sections: [
          {
            ...
            body: [
              "Coverage includes congresses, corporate meetings, conventions, trade shows, product launches, institutional events and multi-session programs. The service is intended for companies and agencies that need reliable documentation of a day without interrupting its rhythm.",
        ...
        facts: ["Available in Turin, Piedmont and throughout Italy for corporate events."],
      },
      it: {
        ...
        sections: [
          {
            ...
            body: [
              "La copertura comprende congressi, meeting aziendali, convention, fiere, lanci prodotto, eventi istituzionali e programmi con più sessioni. Il servizio è pensato per aziende e agenzie che hanno bisogno di documentare una giornata senza interromperne il ritmo.",
        ...
        facts: ["Disponibile a Torino, in Piemonte e in tutta Italia per eventi aziendali."],
      },
    },
  },
  {
    ...
    copy: {
      en: {
        title: "Video footage",
        eyebrow: "Events, interviews and company content",
        intro:
          "Professional video production for corporate events, congresses, interviews and company communication.",
        sourceLabel: "Source pages: video and events.",
        overviewLabel: "Video service",
        detailsLabel: "Applications",
        pricingLabel: "Service notes",
        relatedLabel: "Continue with",
        allServicesLabel: "All services",
        ...
        sections: [
          {
            ...
            body: [
              "Professional filming covers corporate events, congresses, interviews and company communication. It works naturally beside event photography, especially when speeches, movement and atmosphere need to be preserved.",
              "Event coverage can include a best-of film, a concise teaser and short clips prepared for social channels, coordinated with the photography team through one point of contact.",
            ],
            bullets: ["Corporate events and congresses.", "Interviews.", "Best-of films, teasers and short social clips.", "Coordination with still photography."],
          },
        ],
      },
      it: {
        title: "Riprese video",
        eyebrow: "Eventi, interviste e contenuti aziendali",
        intro:
          "Produzione video professionale per eventi aziendali, congressi, interviste e comunicazione d'impresa.",
        sourceLabel: "Pagine fonte: video ed eventi.",
        overviewLabel: "Servizio video",
        detailsLabel: "Applicazioni",
        pricingLabel: "Note sul servizio",
        relatedLabel: "Continua con",
        allServicesLabel: "Tutti i servizi",
        ...
        sections: [
          {
            ...
            body: [
              "Le riprese professionali comprendono eventi aziendali, congressi, interviste e comunicazione d'impresa. Il servizio si affianca in modo naturale alla fotografia di eventi, soprattutto quando discorsi, movimento e atmosfera devono essere conservati.",
              "La copertura di un evento può comprendere un video best-of, un teaser sintetico e brevi clip per i canali social, coordinati con il team fotografico attraverso un unico referente.",
            ],
            bullets: ["Eventi aziendali e congressi.", "Interviste.", "Video best-of, teaser e brevi clip social.", "Coordinamento con la fotografia."],
          },
        ],
      },
    },
        ...
        sections: [
          {
            ...
            body: [
              "The lessons are individual and practical rather than a standardized group course. The format adapts to the learner’s level, questions and goals, covering subjects such as exposure, light, composition, portraiture, urban photography, landscape, still life, products, reportage, events, architecture and post-production.",
              "A DSLR or mirrorless camera is required; this is not smartphone photography training. Lessons take place in the Turin studio and in the field, with immediate feedback and exercises to complete between meetings.",
            ],
        ...
        sections: [
          {
            ...
            body: [
              "Le lezioni sono individuali e pratiche, non un corso di gruppo standardizzato. Il formato si adatta al livello, alle domande e agli obiettivi dell'allievo e può affrontare esposizione, luce, composizione, ritratto, fotografia urbana, paesaggio, still life, prodotto, reportage, eventi, architettura e post-produzione.",
              "È richiesta una fotocamera reflex o mirrorless: non si tratta di un corso di fotografia con smartphone. Le lezioni si svolgono nello studio di Torino e sul campo, con feedback immediato ed esercizi da completare tra un incontro e l'altro.",
            ],
